...
public class Croller extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minWidth = (int) UtilsCroller.convertDpToPixel(160, getContext());
        int minHeight = (int) UtilsCroller.convertDpToPixel(160, getContext());
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (UtilsCroller.getDistance(e.getX(), e.getY(), midx, midy) > Math.max(mainCircleRadius, Math.max(backCircleRadius, progressRadius))) {
